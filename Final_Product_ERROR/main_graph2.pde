...
void draw_graph2(){
  ...
  */
  ...
  // MAX DATA MESSAGE
  fill(255,40);
  rect(main_section[3][0], height-60, main_section[3][0]+textWidth("MAX DATA")+20,height-40);
  fill(255);
  textAlign(LEFT,CENTER);
  text("MAX DATA",main_section[3][0]+10,height-50);
  
  text(maxTime, main_section[3][0]+textWidth("MAX DATA")+40, height-50);
}
